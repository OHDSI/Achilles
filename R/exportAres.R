...
#'
#' @description
#' \code{exportAres} Exports Achilles statistics for use with the Ares interface
#'
#' @details
#' Creates export files for the Ares interface
#' 
#' 
...
exportAres <- function(connectionDetails,cdmDatabaseSchema, resultsDatabaseSchema, outputPath, vocabDatabaseSchema = cdmDatabaseSchema)
{
  ...
  print(paste0("processing ares export to ", sourceOutputPath))
