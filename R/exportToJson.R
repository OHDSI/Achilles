...
getAllReports <- function() {
  reports <- read.csv(
    file = system.file("csv", "export", "all_reports.csv", package = "Achilles"),
...
exportToJson <- function(connectionDetails,
  ...
  if ("CONDITION" %in% reports) {
    generateConditionTreemap(
      conn, connectionDetails$dbms, cdmDatabaseSchema, resultsDatabaseSchema,
  ...
  if (compressIntoOneFile) {
    zip(
      zipfile = file.path(
        outputPath,
        sprintf("%s.zip", cdmDatabaseSchema)
      ), files = c(outputPath),
      flags = c("-r")
    )
  }
...
generateAchillesPerformanceReport <- function(conn,
  ...
  queryAchillesPerformance <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/performance/sqlAchillesPerformance.sql",
...
generateMetadataReport <- function(
    conn, dbms, cdmDatabaseSchema, resultsDatabaseSchema, outputPath,
    vocabDatabaseSchema = cdmDatabaseSchema) {
...
generateDrugEraTreemap <- function(
  ...
  queryDrugEraTreemap <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/drugera/sqlDrugEraTreemap.sql",
    packageName = "Achilles", dbms = dbms, warnOnMissingParameters = FALSE, cdm_database_schema = cdmDatabaseSchema,
    results_database_schema = resultsDatabaseSchema, vocab_database_schema = vocabDatabaseSchema
  )
...
generateDrugTreemap <- function(conn,
  ...
  queryDrugTreemap <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/drug/sqlDrugTreemap.sql",
    packageName = "Achilles", dbms = dbms, warnOnMissingParameters = FALSE, cdm_database_schema = cdmDatabaseSchema,
    results_database_schema = resultsDatabaseSchema, vocab_database_schema = vocabDatabaseSchema
  )
  ...
  write(
    jsonlite::toJSON(dataDrugTreemap, method = "C"),
...
generateConditionTreemap <- function(conn,
  ...
  queryConditionTreemap <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/condition/sqlConditionTreemap.sql",
    packageName = "Achilles", dbms = dbms, warnOnMissingParameters = FALSE, cdm_database_schema = cdmDatabaseSchema,
    results_database_schema = resultsDatabaseSchema, vocab_database_schema = vocabDatabaseSchema
  )
  ...
  write(
    jsonlite::toJSON(dataConditionTreemap, method = "C"),
...
generateConditionEraTreemap <- function(conn,
  ...
  queryConditionEraTreemap <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/conditionera/sqlConditionEraTreemap.sql",
    packageName = "Achilles", dbms = dbms, warnOnMissingParameters = FALSE, cdm_database_schema = cdmDatabaseSchema,
    results_database_schema = resultsDatabaseSchema, vocab_database_schema = vocabDatabaseSchema
  )
  ...
  write(
    jsonlite::toJSON(dataConditionEraTreemap, method = "C"),
...
generateConditionReports <- function(conn,
  ...
  buildConditionReport <- function(concept_id) {
    ...
    report$PREVALENCE_BY_MONTH <- dataPrevalenceByMonth[
      dataPrevalenceByMonth$CONCEPT_ID == concept_id,
      c(3, 4)
    ]
...
generateConditionEraReports <- function(conn,
  ...
  buildConditionEraReport <- function(concept_id) {
    ...
    report$LENGTH_OF_ERA <- dataLengthOfEra[dataLengthOfEra$CONCEPT_ID == concept_id, c(
      2, 3, 4,
      5, 6, 7, 8, 9
    )]
    report$AGE_AT_FIRST_DIAGNOSIS <- dataAgeAtFirstDiagnosis[dataAgeAtFirstDiagnosis$CONCEPT_ID ==
...
generateDrugEraReports <- function(
    conn, dbms, cdmDatabaseSchema, resultsDatabaseSchema, outputPath,
    vocabDatabaseSchema = cdmDatabaseSchema) {
  ...
  buildDrugEraReport <- function(concept_id) {
    ...
    report$AGE_AT_FIRST_EXPOSURE <- dataAgeAtFirstExposure[
      dataAgeAtFirstExposure$CONCEPT_ID == concept_id,
      c(2, 3, 4, 5, 6, 7, 8, 9)
    ]
    report$PREVALENCE_BY_GENDER_AGE_YEAR <- dataPrevalenceByGenderAgeYear[dataPrevalenceByGenderAgeYear$CONCEPT_ID ==
      concept_id, c(2, 3, 4, 5)]
...
generateProcedureTreemap <- function(conn,
  ...
  queryProcedureTreemap <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/procedure/sqlProcedureTreemap.sql",
    packageName = "Achilles", dbms = dbms, warnOnMissingParameters = FALSE, cdm_database_schema = cdmDatabaseSchema,
    results_database_schema = resultsDatabaseSchema, vocab_database_schema = vocabDatabaseSchema
  )
  ...
  write(
    jsonlite::toJSON(dataProcedureTreemap, method = "C"),
...
generateProcedureReports <- function(conn,
  ...
  dataProcedureFrequencyDistribution <- DatabaseConnector::querySql(
    conn,
...
generatePersonReport <- function(conn,
  ...
  renderedSql <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/person/yearofbirth_stats.sql",
    packageName = "Achilles", dbms = dbms, warnOnMissingParameters = FALSE, cdm_database_schema = cdmDatabaseSchema,
    results_database_schema = resultsDatabaseSchema, vocab_database_schema = vocabDatabaseSchema
  )
  ...
  renderedSql <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/person/yearofbirth_data.sql",
    packageName = "Achilles", dbms = dbms, warnOnMissingParameters = FALSE, cdm_database_schema = cdmDatabaseSchema,
    results_database_schema = resultsDatabaseSchema, vocab_database_schema = vocabDatabaseSchema
  )
...
generateMeasurementTreemap <- function(conn,
  ...
  queryMeasurementTreemap <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/measurement/sqlMeasurementTreemap.sql",
    packageName = "Achilles", dbms = dbms, warnOnMissingParameters = FALSE, cdm_database_schema = cdmDatabaseSchema,
    results_database_schema = resultsDatabaseSchema, vocab_database_schema = vocabDatabaseSchema
  )
  ...
  write(
    jsonlite::toJSON(dataMeasurementTreemap, method = "C"),
...
generateMeasurementReports <- function(conn,
  ...
  dataMeasurementValueDistribution <- DatabaseConnector::querySql(
    conn,
  ...
  buildMeasurementReport <- function(concept_id) {
    ...
    report$RECORDS_BY_UNIT <- dataRecordsByUnit[
      dataRecordsByUnit$MEASUREMENT_CONCEPT_ID == concept_id,
      c(4, 5)
    ]
...
generateObservationTreemap <- function(conn,
  ...
  queryObservationTreemap <- SqlRender::loadRenderTranslateSql(
    sqlFilename = "export/observation/sqlObservationTreemap.sql",
    packageName = "Achilles", dbms = dbms, warnOnMissingParameters = FALSE, cdm_database_schema = cdmDatabaseSchema,
    results_database_schema = resultsDatabaseSchema, vocab_database_schema = vocabDatabaseSchema
  )
  ...
  write(
    jsonlite::toJSON(dataObservationTreemap, method = "C"),
...
generateVisitTreemap <- function(conn,
  ...
  queryVisitTreemap <- SqlRender::loadRenderTranslateSql(
  ...
  write(
    jsonlite::toJSON(dataVisitTreemap, method = "C"),
...
generateVisitDetailTreemap <- function(conn,
  ...
  queryVisitDetailTreemap <- SqlRender::loadRenderTranslateSql(
  ...
  write(
    jsonlite::toJSON(dataVisitDetailTreemap, method = "C"),
