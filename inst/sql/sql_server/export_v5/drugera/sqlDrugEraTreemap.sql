...
from (select * from @cdm_database_schema.ACHILLES_results where analysis_id = 900) ar1
	inner join
	(select stratum_1, avg_value from @cdm_database_schema.ACHILLES_results_dist where analysis_id = 907) ar2
