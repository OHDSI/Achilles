...
from (select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 600) ar1
	inner join
	(select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 601) ar2
