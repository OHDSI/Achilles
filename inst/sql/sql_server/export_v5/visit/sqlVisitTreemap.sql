...
from (select * from @cdm_database_schema.ACHILLES_results where analysis_id = 200) ar1
	inner join
	(select * from @cdm_database_schema.ACHILLES_results where analysis_id = 201) ar2 on ar1.stratum_1 = ar2.stratum_1
