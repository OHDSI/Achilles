...
from (select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 700) ar1
	inner join
	(select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 701) ar2
