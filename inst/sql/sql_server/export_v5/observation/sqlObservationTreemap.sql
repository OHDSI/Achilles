...
from (select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 800) ar1
	inner join
	(select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 801) ar2
