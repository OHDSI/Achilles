...
from 
	(select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 504) num
	inner join
	(select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 116) denom on num.stratum_1 = denom.stratum_1  --calendar year
