...
from (select * from @cdm_database_schema.ACHILLES_results where analysis_id = 400) ar1
	inner join
	(select * from @cdm_database_schema.ACHILLES_results where analysis_id = 401) ar2
