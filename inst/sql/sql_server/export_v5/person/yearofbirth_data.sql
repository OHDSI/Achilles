...
from (select * from @cdm_database_schema.ACHILLES_results where analysis_id = 3) ar1,
	(select min(cast(stratum_1 as int)) as MinValue from @cdm_database_schema.ACHILLES_results where analysis_id = 3) MinValue,
