...
from 
	(select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 1802) num
	inner join
	(select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 117) denom on num.stratum_2 = denom.stratum_1  --calendar year
