...
from (select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 1800) ar1
	inner join
	(select * from @cdm_database_schema.ACHILLES_resultss where analysis_id = 1801) ar2
