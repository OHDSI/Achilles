...
select 920 as analysis_id,   
	CAST(YEAR(drug_era_start_datetime)*100 + month(drug_era_start_datetime) AS VARCHAR(255)) as stratum_1,
...
group by YEAR(drug_era_start_datetime)*100 + month(drug_era_start_datetime)
;
