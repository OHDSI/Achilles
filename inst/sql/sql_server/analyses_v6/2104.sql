...
select 2104 as analysis_id,   
	...
	CAST(YEAR(device_exposure_start_datetime) AS VARCHAR(255)) as stratum_2,
	CAST(p1.gender_concept_id AS VARCHAR(255)) as stratum_3,
	CAST(floor((year(device_exposure_start_datetime) - p1.year_of_birth)/10) AS VARCHAR(255)) as stratum_4,
...
group by m.device_CONCEPT_ID, 
	YEAR(device_exposure_start_datetime),
	p1.gender_concept_id,
	floor((year(device_exposure_start_datetime) - p1.year_of_birth)/10)
;
