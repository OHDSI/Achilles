...
select 1004 as analysis_id,   
	...
	CAST(YEAR(condition_era_start_datetime) AS VARCHAR(255)) as stratum_2,
	CAST(p1.gender_concept_id AS VARCHAR(255)) as stratum_3,
	CAST(floor((year(condition_era_start_datetime) - p1.year_of_birth)/10) AS VARCHAR(255)) as stratum_4,
...
group by ce1.condition_concept_id, 
	YEAR(condition_era_start_datetime),
	p1.gender_concept_id,
	floor((year(condition_era_start_datetime) - p1.year_of_birth)/10)
;
