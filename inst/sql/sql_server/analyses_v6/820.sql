...
select 820 as analysis_id,   
	CAST(YEAR(observation_datetime)*100 + month(observation_datetime) AS VARCHAR(255)) as stratum_1,
...
group by YEAR(observation_datetime)*100 + month(observation_datetime)
;
