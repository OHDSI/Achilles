...
select 2102 as analysis_id,   
	...
	CAST(YEAR(device_exposure_start_datetime)*100 + month(device_exposure_start_datetime) AS VARCHAR(255)) as stratum_2,
...
group by m.device_CONCEPT_ID, 
	YEAR(device_exposure_start_datetime)*100 + month(device_exposure_start_datetime)
;
