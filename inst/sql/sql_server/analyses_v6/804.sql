...
select 804 as analysis_id,   
	...
	CAST(YEAR(observation_datetime) AS VARCHAR(255)) as stratum_2,
	CAST(p1.gender_concept_id AS VARCHAR(255)) as stratum_3,
	CAST(floor((year(observation_datetime) - p1.year_of_birth)/10) AS VARCHAR(255)) as stratum_4,
...
group by o1.observation_concept_id, 
	...
	floor((year(observation_datetime) - p1.year_of_birth)/10)
;
