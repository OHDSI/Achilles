...
select 1804 as analysis_id,   
	...
	CAST(YEAR(measurement_datetime) AS VARCHAR(255)) as stratum_2,
	CAST(p1.gender_concept_id AS VARCHAR(255)) as stratum_3,
	CAST(floor((year(measurement_datetime) - p1.year_of_birth)/10) AS VARCHAR(255)) as stratum_4,
...
group by m.measurement_concept_id, 
	YEAR(measurement_datetime),
	p1.gender_concept_id,
	floor((year(measurement_datetime) - p1.year_of_birth)/10)
;
