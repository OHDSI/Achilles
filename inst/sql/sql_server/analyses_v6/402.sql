...
select 402 as analysis_id,   
	...
	CAST(YEAR(condition_start_datetime)*100 + month(condition_start_datetime) AS VARCHAR(255)) as stratum_2,
...
group by co1.condition_concept_id, 
	YEAR(condition_start_datetime)*100 + month(condition_start_datetime)
;
