...
inner join
(
	select person_id, drug_concept_id, min(year(drug_exposure_start_datetime)) as drug_start_year
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_706
from #tempResults
;
