...
select 220 as analysis_id,   
	CAST(YEAR(visit_start_datetime)*100 + month(visit_start_datetime) AS VARCHAR(255)) as stratum_1,
...
group by YEAR(visit_start_datetime)*100 + month(visit_start_datetime)
;
