...
SELECT 
	person_id,
	COUNT_BIG(DISTINCT visit_detail_concept_id) AS count_value
FROM 
...
SELECT 
	...
	p75_value,
	p90_value
INTO @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1303
FROM #tempResults_1303
;
