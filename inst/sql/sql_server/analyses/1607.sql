-- 1607	Distribution of paid_by_patient by procedure_concept_id
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1607
from #tempResults_1607
;

truncate table #tempResults_1607;
drop table #tempResults_1607;
