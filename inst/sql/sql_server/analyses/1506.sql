-- 1506	Distribution of paid_by_primary by drug_concept_id

with rawData(stratum1_id, count_value) as
(
 select de.drug_concept_id  as stratum1_id,
        c.paid_by_primary   as count_value
 ...
 where c.cost_domain_id = 'Drug'
   and c.paid_by_primary is not null
),
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1506
from #tempResults_1506
;

truncate table #tempResults_1506;
drop table #tempResults_1506;
