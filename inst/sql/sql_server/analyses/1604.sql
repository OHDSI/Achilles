-- 1604	Distribution of paid_patient_deductible by procedure_concept_id
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1604
from #tempResults_1604
;

truncate table #tempResults_1604;
drop table #tempResults_1604;
