-- 1504	Distribution of paid_patient_deductible by drug_concept_id

with rawData(stratum1_id, count_value) as
(
 select de.drug_concept_id         as stratum1_id,
        c.paid_patient_deductible  as count_value
 ...
 where c.cost_domain_id = 'Drug'
   and c.paid_patient_deductible is not null
),
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1504
from #tempResults_1504
;

truncate table #tempResults_1504;
drop table #tempResults_1504;
