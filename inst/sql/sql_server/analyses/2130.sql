-- 2130 Number and proportion of look back days by device_concept_id.
...
select de.device_concept_id,
 ...
 group by de.device_concept_id, datediff(d,op.observation_period_start_date,de.device_exposure_start_date)
), lookback_prop as (
