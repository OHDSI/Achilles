-- 1606	Distribution of paid_by_primary by procedure_concept_id
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1606
from #tempResults_1606
;

truncate table #tempResults_1606;
drop table #tempResults_1606;
