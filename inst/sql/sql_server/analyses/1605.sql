-- 1605	Distribution of paid_by_payer by procedure_concept_id
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1605
from #tempResults_1605
;

truncate table #tempResults_1605;
drop table #tempResults_1605;
