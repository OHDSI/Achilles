-- 1510	Distribution of paid_dispensing_fee by drug_concept_id

with rawData(stratum1_id, count_value) as
(
 select de.drug_concept_id      as stratum1_id,
        c.paid_dispensing_fee   as count_value
 ...
 where c.cost_domain_id = 'Drug'
   and c.paid_dispensing_fee is not null
),
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1510
from #tempResults_1510
;

truncate table #tempResults_1510;
drop table #tempResults_1510;
