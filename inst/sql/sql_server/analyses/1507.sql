-- 1507	Distribution of paid_by_patient by drug_concept_id

with rawData(stratum1_id, count_value) as
(
 select de.drug_concept_id  as stratum1_id,
        c.paid_by_patient   as count_value
 ...
 where c.cost_domain_id = 'Drug'
   and c.paid_by_patient is not null
),
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1507
from #tempResults_1507
;

truncate table #tempResults_1507;
drop table #tempResults_1507;
