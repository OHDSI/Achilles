-- 1502	Distribution of paid_patient_copay by drug_concept_id

with rawData(stratum1_id, count_value) as
(
 select de.drug_concept_id    as stratum1_id,
        c.paid_patient_copay  as count_value
 ...
 where c.cost_domain_id = 'Drug'
   and c.paid_patient_copay is not null
),
...
into @scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1502
from #tempResults_1502
;

truncate table #tempResults_1502;
drop table #tempResults_1502;
