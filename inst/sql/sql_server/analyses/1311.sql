-- 1311	Distribution of length of stay by visit_detail_concept_id
...
SELECT 
	...
	p90_value
INTO 
	@scratchDatabaseSchema@schemaDelim@tempAchillesPrefix_dist_1311
FROM 
	#tempResults_1311;

TRUNCATE TABLE #tempResults_1311;
DROP TABLE #tempResults_1311;
