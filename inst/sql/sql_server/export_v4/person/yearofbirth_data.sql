...
from (select * from ACHILLES_results where analysis_id = 3) ar1,
	(select min(cast(stratum_1 as int)) as MinValue from ACHILLES_results where analysis_id = 3) MinValue,
