...
insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('DrugExposure:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 701;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('DrugEra:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 901;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Condition:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 401;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Procedure:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 601;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Observation:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 801;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Measurement:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 1801;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Visit:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 201;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Death:DeathType:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 505;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Death:DeathCause:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 501;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Person:Race:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 4;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Person:Ethnicity:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 5;


insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Device:ConceptCnt' AS VARCHAR(255)) as measure_id
from @results_database_schema.ACHILLES_results where analysis_id = 2101;

insert into @results_database_schema.ACHILLES_results_derived (statistic_value,measure_id)    
select count(*) as statistic_value, CAST('Note:ConceptCnt' AS VARCHAR(255)) as measure_id
...
select 
count(*) as statistic_value,
CAST('Provider:SpeciatlyCnt' AS VARCHAR(255)) as measure_id
...
insert into @results_database_schema.ACHILLES_results_derived (stratum_1,statistic_value,measure_id)    
select CAST(decade AS VARCHAR(255)) as stratum_1,temp_cnt as statistic_value,
...
insert into @results_database_schema.ACHILLES_results_derived (stratum_1,statistic_value,measure_id)    
select CAST(analysis_id AS VARCHAR(255)) as stratum_1,COUNT_BIG(*) as statistic_value,
...
SELECT DISTINCT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; count (n=', cast(or1.count_value as VARCHAR), ') should not be > 0') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
	1 as rule_id,
	or1.count_value
...
SELECT ord1.analysis_id,
  CAST(CONCAT('ERROR: ', cast(ord1.analysis_id as VARCHAR(10)), ' - ', oa1.analysis_name, ' (count = ', cast(COUNT_BIG(ord1.min_value) as VARCHAR), '); min value should not be negative') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  2 as rule_id,
...
SELECT ord1.analysis_id,
  CAST(CONCAT('WARNING: ', cast(ord1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, ' (count = ', cast(COUNT_BIG(ord1.max_value) as VARCHAR), '); max value should not be positive, otherwise its a zombie with data >1mo after death ') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  3 as rule_id,
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; ', cast(COUNT_BIG(DISTINCT stratum_1) AS VARCHAR), ' concepts in data are not in vocabulary') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  4 as rule_id,
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; ', cast(COUNT_BIG(DISTINCT stratum_2) AS VARCHAR), ' concepts in data are not in vocabulary') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  5 as rule_id,
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; ', cast(COUNT_BIG(DISTINCT stratum_1) AS VARCHAR), ' concepts in data are not in correct vocabulary') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  7 as rule_id,
  COUNT_BIG(DISTINCT stratum_1) as record_count
FROM @results_database_schema.ACHILLES_results or1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; ', cast(COUNT_BIG(DISTINCT stratum_1) AS VARCHAR), ' concepts in data are not in correct vocabulary (CMS Ethnicity)') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  9 as rule_id,
  COUNT_BIG(DISTINCT stratum_1) as record_count
FROM @results_database_schema.ACHILLES_results or1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; ', cast(COUNT_BIG(DISTINCT stratum_1) AS VARCHAR), ' concepts in data are not in correct vocabulary (Specialty)') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  11 as rule_id,
  COUNT_BIG(DISTINCT stratum_1) as record_count
FROM @results_database_schema.ACHILLES_results or1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; ', cast(COUNT_BIG(DISTINCT stratum_1) AS VARCHAR), ' concepts in data are not in correct vocabulary (revenue code)') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  17 as rule_id,
  COUNT_BIG(DISTINCT stratum_1) as record_count
FROM @results_database_schema.ACHILLES_results or1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; should not have year of birth in the future, (n=', cast(sum(or1.count_value) as VARCHAR), ')') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  18 as rule_id,
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; should not have year of birth < 1800, (n=', cast(sum(or1.count_value) as VARCHAR), ')') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  19 as rule_id,
  sum(or1.count_value) as record_count
FROM @results_database_schema.ACHILLES_results or1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; should not have age < 0, (n=', cast(sum(or1.count_value) as VARCHAR), ')') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  20 as rule_id,
  sum(or1.count_value) as record_count
FROM @results_database_schema.ACHILLES_results or1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
SELECT or1.analysis_id,
	CAST(CONCAT('ERROR: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; should not have age > 150, (n=', cast(sum(or1.count_value) as VARCHAR), ')') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  21 as rule_id,
  sum(or1.count_value) as record_count
FROM @results_database_schema.ACHILLES_results or1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
SELECT ar1.analysis_id,
	CAST(CONCAT('WARNING: ', cast(ar1.analysis_id as VARCHAR(10)), '-', aa1.analysis_name, '; ', cast(COUNT_BIG(DISTINCT ar1.stratum_1) AS VARCHAR), ' concepts have a 100% change in monthly count of events') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  23 as rule_id,
...
SELECT ord1.analysis_id,
  CAST(CONCAT('WARNING: ', cast(ord1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, ' (count = ', cast(COUNT_BIG(ord1.max_value) as VARCHAR), '); max value should not be > 180') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  24 as rule_id,
  COUNT_BIG(ord1.max_value) as record_count
FROM @results_database_schema.ACHILLES_results_dist ord1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
SELECT ord1.analysis_id,
  CAST(CONCAT('WARNING: ', cast(ord1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, ' (count = ', cast(COUNT_BIG(ord1.max_value) as VARCHAR), '); max value should not be > 10') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  25 as rule_id,
  COUNT_BIG(ord1.max_value) as record_count
FROM @results_database_schema.ACHILLES_results_dist ord1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
SELECT ord1.analysis_id,
  CAST(CONCAT('WARNING: ', cast(ord1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, ' (count = ', cast(count(ord1.max_value) as VARCHAR), '); max value should not be > 600') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  26 as rule_id,
...
into #tempResults 
from t1
cross join (select CAST(count_value AS FLOAT) as count_value from @results_database_schema.achilles_results where analysis_id = 1821) as ct
;
...
SELECT or1.analysis_id,
	CAST(CONCAT('WARNING: ', cast(or1.analysis_id as VARCHAR(10)), '-', oa1.analysis_name, '; should not have age > @ThresholdAgeWarning, (n=', cast(sum(or1.count_value) as VARCHAR), ')') AS VARCHAR(255)) AS ACHILLES_HEEL_warning,
  36 as rule_id,
  sum(or1.count_value) as record_count
FROM @results_database_schema.ACHILLES_results or1
INNER JOIN @results_database_schema.ACHILLES_analysis oa1
...
CROSS JOIN (SELECT sum(count_value) as all_visits FROM @results_database_schema.achilles_results r WHERE  analysis_id =201 ) c2;
...
from
 (
  ...
  from @results_database_schema.achilles_results
		cross join (select sum(count_value) as count_value from @results_database_schema.achilles_results where analysis_id = 201) c1
...
from
 (select 100.0*achilles_results.count_value/ct.total_pts as one_obs_per_perc
  from @results_database_schema.achilles_results
	cross join (select count_value as total_pts from @results_database_schema.achilles_results r where analysis_id =1) as ct
