...
(
  ...
  from @scratchDatabaseSchema@schemaDelim@heelPrefix_serial_rd_@rdOldId A
  join (select statistic_value as val from @scratchDatabaseSchema@schemaDelim@heelPrefix_serial_rd_@rdOldId  
